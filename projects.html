...
<head>
    ...
    <title>Vertex Energy - Projects</title>
                ...
                <div class="footer__nav">
                    <div class="footer__nav-about">
                        ...
                        <p class="footer__nav-about--description">
                            Vertex Energy International, founded in 2023, is your trusted partner in
                    ...
                    <div class="footer__nav-navigation">
                        <div class="footer__nav-navigation--navbar">
                            ...
                            <ul class="footer__nav-menu">
                                ...
                                <li class="footer__nav-menu--item">
                                    <a href="projects.html" class="footer__nav-menu--link footer__nav-menu--link-active">Projects</a>
                                </li>
                            </ul>
                        </div>
