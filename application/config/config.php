...
|
*/
$config['base_url'] = 'https://vertexenergy.az/';
...
$config['sess_cookie_name'] = 've_session';
...
$config['csrf_token_name'] = 'csrf_vertex_energy';
$config['csrf_cookie_name'] = 'csrf_cookie_vertex_energy';
